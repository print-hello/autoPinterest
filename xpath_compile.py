...
xpath["get_relationship_counts"] = {
    "following_count": "//a[contains(@href,'following') and not(contains(@href,'mutual'))]/div/font[1]",
    "followers_count": "//a[contains(@href,'followers') and not(contains(@href,'mutual'))]/div/font[1]",
    "user_name": "//span[contains(text(), '@')]",
}
